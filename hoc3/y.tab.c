...
{
       0,    33,    33,    34,    35,    36,    37,    39,    43,    44,
      48,    49,    50,    51,    52,    53,    57,    58,    59
};
#endif
...
#line 39 "hoc3.y"
    { 
                  (yyval.val) = (yyvsp[(1) - (3)].sym)->u.val = (yyvsp[(3) - (3)].val); //$$=mem[$1]=$3;
                  (yyvsp[(1) - (3)].sym)->type=VAR; }
    break;
...
#line 44 "hoc3.y"
    { if((yyvsp[(1) - (1)].sym)->type == INDEF)
		...
		(yyval.val)=(yyvsp[(1) - (1)].sym)->u.val;//$$=mem[$1];
	      }
    break;
